class Job < ApplicationRecord
  ...
  #   channel = "updates"
  #   response = firebase.push(channel, {sender: self.expert.name, job_id: self.id, created_at: Time.now, system: true, expert_id: self.expert.id, user_id: self.customer.id})
